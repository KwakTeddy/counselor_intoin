...
+ (UIButton *)defaultAccessoryButtonItem
{
    ...
    UIImage *normalImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];
    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];

    UIButton *accessoryButton = [[UIButton alloc] initWithFrame:CGRectMake(0.0f, 0.0f, accessoryImage.size.width, 35.0f)];
...
{
    NSString *sendTitle = [NSBundle jsq_localizedStringForKey:@"보내기"];
