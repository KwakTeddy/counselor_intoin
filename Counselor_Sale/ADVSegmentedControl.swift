...
@IBDesignable class ADVSegmentedControl: UIControl {
    ...
    var items: [String] = ["업무일지", "현장별 명함", "내 소개"] {
        didSet {
            setupLabels()
        }
    }
    ...
    @IBInspectable var borderColor : UIColor = UIColor(red: 245/255, green: 200/255, blue: 36/255, alpha: 1){
        didSet {
            layer.borderColor = borderColor.cgColor
        }
    }
    
    @IBInspectable var font : UIFont! = UIFont(name: "AppleSDGothicNeo-semiBold", size: 14) {
        didSet {
            setFont()
        }
    }
...
//        thumbView.layer.cornerRadius = thumbView.frame.height
    ...
    func displayNewSelectedIndex(){
        ...
        UIView.animate(withDuration: 0.5, delay: 0.0, usingSpringWithDamping: 0.5, initialSpringVelocity: 0.9, options: [], animations: {
